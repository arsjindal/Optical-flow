...
if __name__ == '__main__':
	...
	new_bbox = bboxes[0]
	x_orig = int(new_bbox[0])
	y_orig = int(new_bbox[1])
	w_orig = int(new_bbox[2])
	h_orig = int(new_bbox[3])
	#pdb.set_trace()
	...
	for i in range(300):
		...
		new_bbox = Translation.applyGeometricTransformations(new_bbox,i,image_1)
